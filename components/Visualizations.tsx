    ...
    return (
        ...
        >
            ...
            <div className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 transition-all duration-200 pointer-events-none ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
                <div className="bg-dark-900 border border-white/20 p-3 rounded-lg shadow-xl text-xs text-center backdrop-blur-md relative">
                ...
                {Array.from({ length: daysInMonth }).map((_, i) => {
                    ...
                    return (
                        <div
                            ...
                            className={`w-4 h-4 rounded-sm ${bgClass} group relative cursor-default transition-all duration-300 ${isHovered ? 'z-[200]' : 'hover:z-[100] active:z-[100]'}`}
                        >
                            {/* Start Marker */}
